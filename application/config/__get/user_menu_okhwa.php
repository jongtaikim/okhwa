...
$menu[$cate1]['submenu'][$cate2]['w'] = "11%;margin-left:5%";
...
$cate2++;
$menu[$cate1]['submenu'][$cate2]['title'] = "20평형";
$menu[$cate1]['submenu'][$cate2]['title2'] = "20pyeong";
$menu[$cate1]['submenu'][$cate2]['w'] = "11%";
$menu[$cate1]['submenu'][$cate2]['link'] = "#/user/page/p?designs=".HOST."&p=room_20&number=101";;

$cate2++;
$menu[$cate1]['submenu'][$cate2]['title'] = "40평형";
$menu[$cate1]['submenu'][$cate2]['title2'] = "40pyeong";
$menu[$cate1]['submenu'][$cate2]['w'] = "11%";
$menu[$cate1]['submenu'][$cate2]['link'] = "#/user/page/p?designs=".HOST."&p=room_40&number=101";;

$cate2++;
$menu[$cate1]['submenu'][$cate2]['title'] = "50평형";
$menu[$cate1]['submenu'][$cate2]['title2'] = "50pyeong";
$menu[$cate1]['submenu'][$cate2]['w'] = "11%";
$menu[$cate1]['submenu'][$cate2]['link'] = "#/user/page/p?designs=".HOST."&p=room_50&number=101";;

$cate2++;
$menu[$cate1]['submenu'][$cate2]['title'] = "100평형";
$menu[$cate1]['submenu'][$cate2]['title2'] = "100pyeong";
$menu[$cate1]['submenu'][$cate2]['w'] = "11%";
$menu[$cate1]['submenu'][$cate2]['link'] = "#/user/page/p?designs=".HOST."&p=room_100&number=101";;
